...
<div class="flex md:flex-row flex-col w-full">
    <div class="xl:w-2/3 md:w-3/5 min-h-96 md:py-8 xl:pl-64 xl:pr-8 xl:px-0 md:px-32 px-8 pt-16 pb-8 flex flex-col md:items-start md:text-left text-center items-center justify-center gap-2">
